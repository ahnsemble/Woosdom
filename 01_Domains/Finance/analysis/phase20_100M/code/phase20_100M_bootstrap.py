...
OUT_DIR_NAME = os.environ.get('PHASE20_BOOT_OUTDIR', 'phase20_1M')
PHASE20_1M_DIR = BASE_DIR / '01_Domains' / 'Finance' / 'analysis' / OUT_DIR_NAME
PHASE20_CODE_DIR = PHASE20_DIR / 'code'

DEV_PHASE20_1M_DIR = Path('/Users/woosung/Desktop/Dev/Woosdom_Brain/01_Domains/Finance/analysis') / OUT_DIR_NAME
...
BLOCK = int(os.environ.get('PHASE20_BOOT_BLOCK', '12'))
N_BOOT = int(os.environ.get('PHASE20_BOOT_N', '1000000'))
SEED = int(os.environ.get('PHASE20_BOOT_SEED', '42'))
if N_BOOT % 1_000_000 == 0:
    BOOT_TAG = f"{N_BOOT // 1_000_000}M"
elif N_BOOT % 1_000 == 0:
    BOOT_TAG = f"{N_BOOT // 1_000}K"
else:
    BOOT_TAG = str(N_BOOT)

OUT_V5 = PHASE20_1M_DIR / f'v5_block12_{BOOT_TAG}_summary.md'
OUT_SPY = PHASE20_1M_DIR / f'spy_block12_{BOOT_TAG}_summary.md'
OUT_6040 = PHASE20_1M_DIR / f'sixty_forty_block12_{BOOT_TAG}_summary.md'
OUT_QS50 = PHASE20_1M_DIR / f'qs50_block12_{BOOT_TAG}_summary.md'
OUT_FOUR = PHASE20_1M_DIR / f'four_way_comparison_{BOOT_TAG}.md'
OUT_CODE = PHASE20_1M_DIR / 'code' / f'phase20_{BOOT_TAG}_bootstrap.py'
...
def write_compare_md(
    *,
    ...
    lines = [
        f"# 4종 비교 — Block Bootstrap {BOOT_TAG} (Block={BLOCK})",
        "",
...
def run() -> None:
    ...
    write_port_md(OUT_V5, f'v5 Block Bootstrap {BOOT_TAG} (Block={BLOCK})', v5_b)
    write_port_md(OUT_SPY, f'SPY Block Bootstrap {BOOT_TAG} (Block={BLOCK})', spy_b)
    write_port_md(OUT_6040, f'60/40 Block Bootstrap {BOOT_TAG} (Block={BLOCK})', s6040_b)
    write_port_md(OUT_QS50, f'QS50 Block Bootstrap {BOOT_TAG} (Block={BLOCK})', qs50_b)
