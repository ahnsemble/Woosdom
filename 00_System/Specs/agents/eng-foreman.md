...
### MessageBus 바인딩
```yaml
inbox: "00_System/MessageBus/inbox/eng-foreman.md"
...
### 발신 가능 대상
- `eng-engineer` — 작업 위임 (task_request)
- `eng-critic` — 작업 위임 (task_request)
- `eng-gitops` — 작업 위임 (task_request)
- `eng-debugger` — 작업 위임 (task_request)
- `eng-vault-keeper` — 작업 위임 (task_request)
...
- 경로: `00_System/MessageBus/outbox/eng-foreman_{{YYYYMMDD-HHMMSS}}.md`
