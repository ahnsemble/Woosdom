...
### MessageBus 바인딩
```yaml
inbox: "00_System/MessageBus/inbox/cmd-dispatcher.md"
...
- `cmd-orchestrator` — 에스컬레이션 (task_request)
...
- 경로: `00_System/MessageBus/outbox/cmd-dispatcher_{{YYYYMMDD-HHMMSS}}.md`
