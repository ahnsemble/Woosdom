...
| # | 콜사인 | 파일 | 역할 | 주 엔진 |
|---|--------|------|------|---------|
| 1 | **Quant** | `quant.md` | 정량 분석, 백테스트, 포트폴리오 수학 | Antigravity Sonnet/Opus / Codex |
| 2 | **Scout** | `scout.md` | 실시간 시장 정보, 뉴스, 매크로 수집 | Antigravity Gemini 3 Pro |
| 3 | **Engineer** | `engineer.md` | 코드 생성, MCP, 자동화 | Codex / Antigravity Sonnet/Opus |
| 4 | **Critic** | `critic.md` | 출력 검증, 반론, 팩트체크 | GPT-5.2 / Gemini 3 Pro (교차 엔진) |
